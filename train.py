...
from utils.plots import plot_images2, plot_labels, plot_results, plot_evolution
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if rank in [-1, 0]:
        ...
        testloader = create_dataloader(test_path, imgsz_test, batch_size*2, gs, opt,
                                       ...
                                       rank=-1, world_size=opt.world_size, workers=opt.workers, mosaic=False)[0]  # testloader
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                if plots and ni < 3:
                    ...
                    plot_images2(images=imgs, targets=targets, paths=paths, fname=f)
                    # if tb_writer:
